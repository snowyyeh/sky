...
app.get('/u', async (req, res) => {
    ...
    if (!await client.db.table('globalPoints').get(id).run() || !client.users.has(id) || client.users.get(id).bot == true) return res.sendFile(__dirname + '/static/invalidprofile.html', {});
    const user = {
